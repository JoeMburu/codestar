# EventEase (Event Management and Booking App)

![freefido responsive screenshot](documentation/final_views/freefido_amiresponsive.png)

## Introduction

EventEase is a speaking event management and booking app. This is the final project for Code Institute's Full-Stack Software Development course - focusing on Django and Bootstrap frameworks, Postgresql Database,  and CRUD functionality. It is for educational purposes only.

View live site here : [FreeFido](App url)  
  
For Admin access with relevant sign-in information: [Freefido Admin](Admin url)
